...
<body>
		...
		<div class="wrapper">
			<div class="panel">
				<div class="panel-heading"><h5>学生管理</h5></div>
				<div class="panel-body">
					<div class="pull-right"><a href="sqltable.jsp"><button class="btn btn-primary">添加栏目</button></a></div>
					<form action="findUserByname?type=2&pageIndex=1&pageNum=8" method="post">
						<div class="search">
   							搜索名称：
					...
					<table class="table table-bordered table-hover table-striped">
				        <thead>
				          	<tr>
					            ...
					            <th width="200" class="text-center">学号</th>
				        ...
				        <tbody>
				          	<tr>
					            ...
					            <td class="text-center">
									...
									<a href="deleteUser?id=${user.id }"> <button type="button" class="btn btn-sm btn-danger"><i class="icon-trash"></i>删除</button></a>
					            </td>
				          	</tr>
