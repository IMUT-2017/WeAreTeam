		...
		<div class="wrapper">
			<div class="panel">
				...
				<div class="panel-body">
					...
					<form action="findClassByname?pageIndex=1&pageNum=4" method="post">
						<div class="search">
   							搜索名称：
   								<input type="text" class="text" name="classname" placeholder="搜索名称" style="width:150px;">
					...
					<table class="table table-bordered table-hover table-striped">
				        <thead>
				          	<tr>
					            ...
					            <th width="200" class="text-center">课程名称</th>
					            <th width="150" class="text-center">介绍</th>
					            <th width="150" class="text-center">开设日期</th>
				      ...
				      <c:forEach items="${list }" var="c">  
				        <tbody>
				          	<tr>
					            ...
					            <td class="text-center">${c.className}</td>
					            <td class="text-center">${c.introduce}</td>
					             <td class="text-center">${c.date}</td>
					            <td class="text-center">
									<button type="button" class="btn btn-sm btn-success"><i class="icon-edit"></i> 编辑</button>
									<a href="deleteClass?id=${c.id }"> <button type="button" class="btn btn-sm btn-danger"><i class="icon-trash"></i>删除</button></a>
					            </td>
				          	</tr>
